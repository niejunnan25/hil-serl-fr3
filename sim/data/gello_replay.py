...
def build_scene() -> tuple:
    ...
    robot_cfg = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            joint_pos={
                "panda_joint1": FR3_HOME_JOINTS[0],
                "panda_joint2": FR3_HOME_JOINTS[1],
                "panda_joint3": FR3_HOME_JOINTS[2],
                "panda_joint4": FR3_HOME_JOINTS[3],
                "panda_joint5": FR3_HOME_JOINTS[4],
                "panda_joint6": FR3_HOME_JOINTS[5],
                "panda_joint7": FR3_HOME_JOINTS[6],
